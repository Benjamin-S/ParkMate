        ...
        INotificationHandler<NewBookingCreatedEvent>
    {
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await _emailSender.SendEmailAsync(notification.Buyer.Email,
                $"New booking for {title} successful",
                $"Dear {notification.Buyer.Name}," +
                $"<br>Congratulations! Your booking for {title} has been confirmed. " +
                    ...
                    "<br>&nbsp;&nbsp; GST: $" + booking.Total.Value * 0.1m +
                    "<br>&nbsp;&nbsp; -------------------------------" +
                    "<br>&nbsp;&nbsp; Total: $" + booking.Total.Value + booking.Total.Value * 0.1m +
                "<br><br>" +
